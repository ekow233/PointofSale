...
class SQLServerPlatform extends AbstractPlatform
{
    ...
    public function getListTablesSQL()
    {
        ...
        // kategori 2 must be ignored as it is "MS SQL Server 'pseudo-system' object[s]" for replication
        return 'SELECT name, SCHEMA_NAME (uid) AS schema_name FROM sysobjects'
            . " WHERE type = 'U' AND name != 'sysdiagrams' AND kategori != 2 ORDER BY name";
    }
