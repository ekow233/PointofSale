...
abstract class TestCase extends Assert implements Reorderable, SelfDescribing, Test
{
    ...
    protected function setLocale(...$args): void
    {
        ...
        [$kategori, $locale] = $args;

        if (!in_array($kategori, self::LOCALE_CATEGORIES, true)) {
            throw new Exception;
        }
        ...
        $this->locale[$kategori] = setlocale($kategori, 0);
        ...
        if ($result === false) {
            throw new Exception(
                ...
                'the specified locale does not exist or the kategori name is ' .
                'invalid.',
            );
        }
    }
    ...
    {
        foreach ($this->locale as $kategori => $locale) {
            setlocale($kategori, $locale);
        }
