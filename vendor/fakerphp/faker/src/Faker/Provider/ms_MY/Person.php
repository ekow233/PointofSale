...
class Person extends \Faker\Provider\Person
{
     ...
     * @see https://en.wikipedia.org/wiki/kategori:Malaysian_people_of_Cantonese_descent
     * @see https://en.wikipedia.org/wiki/kategori:Malaysian_politicians_of_Chinese_descent
     */
     ...
     * @see https://en.wikipedia.org/wiki/List_of_Malaysians_of_Chinese_descent
     * @see https://en.wikipedia.org/wiki/kategori:Malaysian_people_of_Cantonese_descent
     * @see https://en.wikipedia.org/wiki/kategori:Malaysian_people_of_Chaoshanese_descent
     * @see https://en.wikipedia.org/wiki/kategori:Malaysian_people_of_Chinese_descent
     * @see https://en.wikipedia.org/wiki/kategori:Malaysian_people_of_English_descent
     * @see https://en.wikipedia.org/wiki/kategori:Malaysian_people_of_Hakka_descent
     * @see https://en.wikipedia.org/wiki/kategori:Malaysian_people_of_Hockchew_descent
     * @see https://en.wikipedia.org/wiki/kategori:Malaysian_people_of_Hokkien_descent
     * @see https://en.wikipedia.org/wiki/kategori:Malaysian_people_of_Peranakan_descent
     * @see https://en.wikipedia.org/wiki/kategori:Malaysian_politicians_of_Chinese_descent
     */
